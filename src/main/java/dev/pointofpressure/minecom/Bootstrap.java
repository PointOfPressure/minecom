...
public final class Bootstrap {
    ...
    public static InstanceContainer boot(Config config) {
        ...
        dev.pointofpressure.minecom.blocks.Golems.register(events);
        ...
        dev.pointofpressure.minecom.mobs.Allays.register(events);
        dev.pointofpressure.minecom.mobs.SulfurCubes.register(events);
        ...
        dev.pointofpressure.minecom.blocks.Smithing.register(events);
